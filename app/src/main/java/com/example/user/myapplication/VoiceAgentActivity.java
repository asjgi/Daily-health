...
public class VoiceAgentActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button a_button = (Button) findViewById(R.id.voice_agent_call_button);
        a_button.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String url = "https://assistant.google.com/services/a/uid/000000f2742f07a7?hl=en&source=web";
